...
use hive_ui_core::{ReviewCommit, ReviewDiscardAll, ReviewStageAll, ReviewUnstageAll};
...
impl ReviewPanel {
    pub fn render(data: &ReviewData, theme: &HiveTheme) -> impl IntoElement {
        ...
        div()
            ...
            .child(Self::branch_card(data, theme))
    ...
    fn git_actions(theme: &HiveTheme) -> impl IntoElement {
        div()
            .flex()
            .flex_row()
            .gap(theme.space_3)
            ...
            .child(
                Self::action_btn("review-commit", "Commit", theme.accent_green, theme)
                    .on_mouse_down(MouseButton::Left, |_event, window, cx| {
                        window.dispatch_action(Box::new(ReviewCommit), cx);
                    }),
            )
            .child(div().flex_1())
            .child(
                Self::action_btn("review-discard-all", "Discard All", theme.accent_red, theme)
                    .on_mouse_down(MouseButton::Left, |_event, window, cx| {
